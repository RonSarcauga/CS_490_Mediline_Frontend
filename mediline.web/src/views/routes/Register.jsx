...
export default function MultiStepRegistration()
{
    ...
    const currentStepFields = stepFieldsByRole[formData.accountType || "patient"]?.[currentStep] || [];

    const isCurrentStepComplete = currentStepFields.every(
        (field) => formData[field]?.trim() !== "" && fieldValidity[field] === true
    );
    ...
    const handleInput = (field, target) => {
        ...
        console.log("Current fieldValidity:", fieldValidity);
    };
                                                ...
                                                items={[
                                                    <>
                                                            ...
                                                            items={[
                                                                <>
                                                                    <InputBarReg
                                                                        ...
                                                                        onValidChange={setFieldValid("firstname")}
                                                                    />
                                                                    <InputBarReg
                                                                        ...
                                                                        onValidChange={setFieldValid("lastname")}
                                                                    />
                                                                    <InputBarReg
                                                                        value={formData.sex}
                                                        ...
                                                        <InputBarReg
                                                            ...
                                                            onValidChange={setFieldValid("dateOfBirth")}
                                                        />                                                        
                                                        <Container
                                                            ...
                                                            items={[
                                                                <>
                                                                    ...
                                                                    <InputBarReg
                                                                        ...
                                                                        onValidChange={setFieldValid("postalCode")}
                                                                    />
                                                                </>
                                                            ]}
                                                        />
                                                ...
                                                items={[
                                                    <>
                                                        ...
                                                        <InputBarReg
                                                            ...
                                                            inputType="password"
                                                            validationRegex={validatePasswordMatch ? /^.*$/ : /^.{9999,}$/}
                                                            dataAnnotation="Passwords must match"
                                                            onValidChange={setFieldValid("confirmPassword")}
                                                        />
                                                        <Container
                                                            customClass={`button bg-dark-100 justify-items-center align-items-center br-sm`}
                                                            fitParent={true}
                                                            isClickable={validatePasswordMatch && isCurrentStepComplete}
                                                            onClick={handleNext}
                                                            dataAttributes={
                                                                { disabled: !(validatePasswordMatch && isCurrentStepComplete)}
                                                            }
                                                            content={[
                                                                <p className="font-regular text-neutral-1100 py-2">
                                                                    Next
                                                                        ...
                                                                        <ItemGroup
                                                                            ...
                                                                            items={[
                                                                                <>
                                                                                    ...
                                                                                    <p className='font-3 font-medium text-neutral-700'>You are here to provide for your patients</p>
                                                                                </>
                                                                            ]}
                                                                        />
                                                                    </>
                                                    ...
                                                    items={[
                                                        <>
                                                            <InputBarReg
                                                                ...
                                                                onValidChange={setFieldValid("licenseNumber")}
                                                            />
                                                            <InputBarReg
                                                    ...
                                                    items={[
                                                        <>
                                                            ...
                                                            <Container
                                                                customClass="button bg-dark-100 justify-items-center align-items-center br-sm py-4"
                                                                fitParent={true}
                                                                isClickable={isCurrentStepComplete && formData.pharmacyName?.trim() !== "" && formData.pharmacyAddress?.trim() !== "" && !registerMutation.isLoading}
                                                                onClick={handleSubmit}
                                                                dataAttributes={{
                                                                    disabled: (!isCurrentStepComplete || formData.pharmacyName?.trim() == "" || formData.pharmacyAddress?.trim() == "") || registerMutation.isLoading
                                                                }}
                                                                content={[
                                                                    <p className="text-decoration-none font-regular text-neutral-1100">
                                                                    {registerMutation.isLoading ? 'Submitting…' : 'Get Started'}

...
export default function MultiStepRegistration()
{
    ...
    function handleClick(role) {
        ...
        alert(`Account type: ${role}`);
        handleInput('accountType', role);
    }
    ...
    const stepInputs = {
        ...
        3: Object.keys(formData).filter((key) => ["accountType"].includes(key))
    };
                                                        ...
                                                        <>
                                                            <ItemGroup
                                                                ...
                                                                items={[
                                                                    <>
                                                                        <Container
                                                                            customClass="progress-indicator h-450 w-450"
                                                                            content={[
                                                                                <>
                                                                                    <h1 className="font-medium font-8">1</h1>
                                                                                </>
                                                                            ]}
                                                                        />
                                                                        <Container
                                                                            customClass="step-bar h-25 bg-neutral-1000"
                                                                            fitParent={true}
                                                                            maxWidth="200px"
                                                                        />
                                                                        <Container
                                                            ...
                                                            />
                                                            <ItemGroup
                                                                customClass="gap-4 progress-indicator"
                                                                axis={true}
                                                                items={[
                                                                    <>
                                                                        <Container
                                                                ...
                                                                items={[
                                                                    <>
                                                                        <Container
                                                                            customClass="progress-indicator h-450 w-450"
                                                                            content={[
                                                                                <h1 className="font-medium font-8">2</h1>
                                                                            ]}
                                                                        />
                                                                        <Container
                                                                            customClass="step-bar h-25 bg-neutral-1000"
                                                                ...
                                                                items={[
                                                                    <>
                                                                        <Container
                                                                            customClass="progress-indicator h-450 w-450"
                                                                            content={[
                                                                                <h1 className="font-medium font-8">3</h1>
                                                                            ]}
                                                                        />
                                                                        <Container
                                                                            customClass="step-bar h-25 bg-neutral-1000"
                                                                ...
                                                                items={[
                                                                    <>
                                                                        <Container
                                                                            customClass="progress-indicator h-450 w-450"
                                                                            content={[
                                                                                <h1 className="font-medium font-8">4</h1>
                                                                            ]}
                                                                        />
                                                                        <Container
                                                                            customClass="p-0 text-center align-items-center"
                                                ...
                                                items={[
                                                    <>
                                                        <ItemGroup
                                                            ...
                                                            id='doctor'
                                                            customClass={
                                                                `gap-3 br-sm justify-items-center b-4 outline-neutral-1000 hover-outline-secondary-400 py-15 px-4 ${selectedRole === 'doctor' ? 'selected' : ''}`
                                                            }
                                                            isClickable={true}
                                                        ...
                                                        <ItemGroup
                                                            ...
                                                            id='pharmacist'
                                                            customClass={
                                                                `gap-3 br-sm justify-items-center b-4 outline-neutral-1000 hover-outline-secondary-400 py-15 px-4 ${selectedRole === 'pharmacist' ? 'selected' : ''}`
                                                            }
                                                            isClickable={true}
                                                        ...
                                                        <ItemGroup
                                                            ...
                                                            id='patient'
                                                            customClass={
                                                                `gap-3 br-sm justify-items-center b-4 outline-neutral-1000 hover-outline-secondary-400 py-15 px-12 ${selectedRole === 'patient' ? 'selected' : ''}`
                                                            }
                                                            isClickable={true}

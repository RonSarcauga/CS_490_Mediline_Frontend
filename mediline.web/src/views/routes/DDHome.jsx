...
function DDHome() {
    ...
    console.log(`Patients: ${JSON.stringify(dashboardLayoutViewModel.getPatients(doctorData.licenseNumber), null, 2)}`);
                                                                                                                                            ...
                                                                                                                                            <ItemGroup
                                                                                                                                                ...
                                                                                                                                                items={[
                                                                                                                                                    <>
                                                                                                                                                        ...
                                                                                                                                                        <ItemGroup
                                                                                                                                                            customClass="justify-content-space-between pr-5"
                                                                                                                                                            axis={false}
                                                                                                                                                            stretch={true}
                                                                                                                                                            fitParent={true}
                                                                                                                                                            items={[
                                                                                                                                                                <>
                                                                                                                                                                    <ItemGroup
                                                                                                                                                                        ...
                                                                                                                                                                        items={[
                                                                                                                                                                            <>
                                                                                                                                                                                <h5 className="font-4 font-medium text-neutral-600">MRN: {appt.patientMRN}</h5>
                                                                                                                                                                                <h5 className="font-4 font-medium">{dashboardLayoutViewModel.getUsers().find(user => user.id === dashboardLayoutViewModel.getPatientByMRN(appt.patientMRN).userId).firstName} {dashboardLayoutViewModel.getUsers().find(user => user.id === dashboardLayoutViewModel.getPatientByMRN(appt.patientMRN).userId).lastName}</h5>
                                                                                                                                                                            </>
                                                                                                                                                                        ]}
                                                                                                                                                                    />
                                                                                                                                                                    <ItemGroup
                                                                                                                                                                        ...
                                                                                                                                                                        items={[
                                                                                                                                                                            <>
                                                                                                                                                                                <h5 className="font-4 font-medium text-neutral-600">Age</h5>
                                                                                                                                                                                <ItemGroup
                                                                                                                                                                                    ...
                                                                                                                                                                                    items={[
                                                                                                                                                                                        <>
                                                                                                                                                                                            ...
                                                                                                                                                                                            <h5 className="font-4 font-semibold">{dashboardLayoutViewModel.calculateAge(dashboardLayoutViewModel.getUsers().find(user => user.id === dashboardLayoutViewModel.getPatientByMRN(appt.patientMRN).userId).dateOfBirth)}</h5>
                                                                                                                                                                                        </>
                                                                                                                                                                                    ]}
                                                                                                                                                                                />
                                                                                                                                                                            </>
                                                                                                                                                                    ...
                                                                                                                                                                    <ItemGroup
                                                                                                                                                                        ...
                                                                                                                                                                        items={[
                                                                                                                                                                            <>
                                                                                                                                                                                <h5 className="font-4 font-medium text-neutral-600">Date of Birth</h5>
                                                                                                                                                                                <ItemGroup
                                                                                                                                                                                    customClass="gap-1 align-items-center justify-content-center"
                                                                                                                                                                                    axis={false}
                                                                                                                                                                                    stretch={true}
                                                                                                                                                                                    items={[
                                                                                                                                                                                        <>
                                                                                                                                                                                            ...
                                                                                                                                                                                            <h5 className="font-4 font-semibold">{dashboardLayoutViewModel.getUsers().find(user => user.id === dashboardLayoutViewModel.getPatientByMRN(appt.patientMRN).userId).dateOfBirth}</h5>
                                                                                                                                                                                        </>
                                                                                                                                                                                    ]}
                                                                                                                                                                                />
                                                                                                                                                                            </>
                                                                                                                                                                    ...
                                                                                                                                                                    <ItemGroup
                                                                                                                                                                        ...
                                                                                                                                                                        items={[
                                                                                                                                                                            <>
                                                                                                                                                                                <h5 className="font-4 font-medium text-neutral-600">Treatment</h5>
                                                                                                                                                                                <h5 className="font-4 font-semibold">{appt.treatment}</h5>
                                                                                                                                                                            </>
                                                                                                                                                                        ]}
                                                                                                                                                                    />
                                                                                                                                                                </>
                                                                                                                    ...
                                                                                                                    <ItemGroup
                                                                                                                        ...
                                                                                                                        items={[
                                                                                                                            <>
                                                                                                                                ...
                                                                                                                                <p className="font-regular text-neutral-100 font-4">{patient.firstName} {patient.lastName}</p>
                                                                                                                            </>
                                                                                                                        ]}
                                                                                                                    />
                                                                                                                    <ItemGroup

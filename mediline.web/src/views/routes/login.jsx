...
export default function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        // Fetch and store the current user returned by the login method
    ...
    return (
        <Container
            ...
            content={[
                <PictureFrame
                    customClass="login-card br-lg box-shadow-sm"
                    pictureClass="br-right-lg"
                    location="right"
                    url="/img/LoginPage.jpg"
                    content={[
                        <form onSubmit={(e) => e.preventDefault()}>
                            <ItemGroup
                                customClass="p-15 align-items-center bg-neutral-1100 br-left-lg gap-25"
                                fitParent={true}
                                axis={true}
                                items={[
                                    <>
                                        ...
                                        />
                                        <ItemGroup
                                            customClass="justify-items-center text-center gap-15"
                                            stretch={true}
                                            axis={true}
                                            items={[
                                                <>
                                                    <ItemGroup
                                                        customClass="gap-3 px-18"
                                                        items={[
                                                            <>
                                                                <h1 className="font-15 font-semibold">Hello!</h1>
                                                                <p className="font-5 text-neutral-600">Thanks for choosing Mediline. Before you get started, sign into your account.</p>
                                                            </>
                                                        ]}
                                                    />
                                                    <ItemGroup
                                                        customClass="gap-4 px-18"
                                                        axis={true}
                                                        fitParent={true}
                                                        items={[
                                                            <>
                                                    ...
                                                    <ItemGroup
                                                        ...
                                                        items={[
                                                            <>
                                                                ...
                                                                <Link to="/register" className="text-decoration-none font-medium text-secondary-200">
                                                                    Sign up
                                                                </Link>
                                                            </>
                                                        ]}

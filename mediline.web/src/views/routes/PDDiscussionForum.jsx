                                                    ...
                                                    items={[
                                                        <>
                                                            ...
                                                            {posts.map((post) => {
                                                                ...
                                                                const hasMoreReplies = replies.length === currentCount;
                                                                                                                                                                                            ...
                                                                                                                                                                                            <ItemGroup
                                                                                                                                                                                                ...
                                                                                                                                                                                                items={[
                                                                                                                                                                                                    <>
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        <h3 className="font-semibold text-neutral-500 font-3">{users.find(user => user.id === reply.userId).firstName} {users.find(user => user.id === reply.userId).lastName}</h3>
                                                                                                                                                                                                    </>
                                                                                                                                                                                                ]}
                                                                                                                                                                                            />
                                                                                                                                                                                            <p className="font-3 text-neutral-500">{reply.timestamp}</p>
                                                                                                                                                                                        </>
                                                                                                                                                                                    ]}
                                                                                                                                                                                />
                                                                                                                                                                                <ItemGroup
                                                                                                                                                                                    ...
                                                                                                                                                                                    items={[
                                                                                                                                                                                        <>
                                                                                                                                                                                            <p className="text-neutral-500 font-3">{reply.content}</p>
                                                                                                                                                                                        </>
                                                                                                                                                                                    ]}
                                                                                                                                                                                />
                                                                                                                                                                            </>

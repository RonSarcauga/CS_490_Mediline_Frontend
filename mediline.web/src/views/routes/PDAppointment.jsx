...
import PatApptViewModel from '../../viewModels/PDAViewModel'
...
function PDAppointment() {
    ...
    const { data: appointment, isLoading, isError, error, } = PatApptViewModel.usePatientAppointments(parseInt(appointmentId));
                                        ...
                                        items={[
                                            <>
                                                                                                                        ...
                                                                                                                        <ItemGroup
                                                                                                                            ...
                                                                                                                            items={[
                                                                                                                                <>
                                                                                                                                    ...
                                                                                                                                    <p className="font-3 font-semibold text-neutral-600">{dashboardLayoutViewModel.formatBirthDate(appointment.start_date)}</p>
                                                                                                                                </>
                                                                                                                            ]}
                                                                                                                        />
                                                                                                                        <ItemGroup
                                                                                                                            ...
                                                                                                                            items={[
                                                                                                                                <>
                                                                                                                                    ...
                                                                                                                                    <p className="font-3 font-semibold text-neutral-600">{dashboardLayoutViewModel.splitDateTime(appointment.start_date).time}</p>
                                                                                                                                </>
                                                                                                                            ]}
                                                                                                                        />
                                                                                                                    </>
                                                                                                ...
                                                                                                <ItemGroup
                                                                                                    ...
                                                                                                    items={[
                                                                                                        <>
                                                                                                            ...
                                                                                                            <p className="font-3 font-semibold text-neutral-600"> Dr. {appointment.doctor_name} </p>
                                                                                                            </>
                                                                                                            ) : (
                                                                                                            <>
                                                                                                            <BaseIcon
                                                                                                            ...
                                                                                                            <p className="font-3 font-semibold text-neutral-600"> {appointment.patient_name} </p>
                                                                                                            </>
                                                                                                            )}
                                                                                                        </>
                                                                                                    ]}
                                                                                        ...
                                                                                        items={[
                                                                                            <>
                                                                                                ...
                                                                                                <ItemGroup
                                                                                                    ...
                                                                                                    items={[
                                                                                                        <>
                                                                                                            <p className="font-3 font-semibold text-neutral-600">{appointment.treatment}</p>
                                                                                                        </>
                                                                                                    ]}
                                                                                                />
                                                                                            </>
                                                ...
                                                <Chatbox
                                                    ...
                                                    data={{
                                                        patient: {name: appointment.patient_name, id: appointment.patient_id},
                                                        doctor: {name: appointment.doctor_name, id: appointment.doctor_id}
                                                    }}
                                                />
                                            </>
                                        ]}
                                                                                                                                                                    ...
                                                                                                                                                                    <ItemGroup
                                                                                                                                                                        ...
                                                                                                                                                                        items={[
                                                                                                                                                                            <>
                                                                                                                                                                                ...
                                                                                                                                                                                <p className="font-3 font-semibold text-neutral-600">{dashboardLayoutViewModel.formatBirthDate(pastapptId.appointmentDate)}</p>
                                                                                                                                                                            </>
                                                                                                                                                                        ]}
                                                                                                                                                                    />
                                                                                                                                                                    <ItemGroup
                                                                                                                                                                        ...
                                                                                                                                                                        items={[
                                                                                                                                                                            <>
                                                                                                                                                                                ...
                                                                                                                                                                                <p className="font-3 font-semibold text-neutral-600">{pastapptId.startTime}</p>
                                                                                                                                                                            </>
                                                                                                                                                                        ]}
                                                                                                                                                                    />
                                                                                                                                                                </>
                                                                                                                                                        ...
                                                                                                                                                        <ItemGroup
                                                                                                                                                            ...
                                                                                                                                                            items={[
                                                                                                                                                                <>
                                                                                                                                                                    ...
                                                                                                                                                                    <p className="font-3 font-semibold text-neutral-600">Dr. {dashboardLayoutViewModel.getUsers().find(user => user.id === dashboardLayoutViewModel.getDoctorByLicense(pastapptId.doctorLicenseNumber).userId).firstName} {dashboardLayoutViewModel.getUsers().find(user => user.id === dashboardLayoutViewModel.getDoctorByLicense(pastapptId.doctorLicenseNumber).userId).lastName}</p>
                                                                                                                                                                </>
                                                                                                                                                            ]}
                                                                                                                                                        />
                                                                                                                                                    </>

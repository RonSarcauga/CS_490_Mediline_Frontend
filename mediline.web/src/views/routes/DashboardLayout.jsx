...
function DashboardLayout() {
   ...
   console.log(`User: ${user.firstName} ${user.lastName}, Role: ${user.role}`);
    ...
    return (
        <Container
            fitScreen={true}
            customClass="bg-secondary-500 align-items-center justify-content-center p-10"
            content={[
                <>
                    <Container
                        customClass="bg-secondary-500 br-md box-shadow p-0 position-relative"
                        style={{
                            minHeight: "90vh",
                            minWidth: "90vw",
                            zIndex: "0"
                        ...
                        content={[
                            <>
                                <Container
                                    customClass="bg-neutral-1100 box-shadow-sm br-top-md position-absolute"
                                    style={{
                                        height: "120px",
                                        width: "100%",
                                        zIndex: "1"
                                ...
                                <ItemGroup
                                    ...
                                    items={[
                                        <>
                                            <ItemGroup
                                                customClass="p-10 gradient-dark br-md gap-8 align-content-center"
                                                style={{
                                                    zIndex: "2"
                                                }}
                                                axis={true}
                                            ...
                                            <ItemGroup
                                                ...
                                                items={[
                                                    <>
                                                        <ItemGroup
                                                            customClass="gap-3 pl-10 pr-12 py-8 align-items-center justify-content-space-between"
                                                            fitParent={true}
                                                            stretch={true}
                                                            axis={false}
                                                            style={{

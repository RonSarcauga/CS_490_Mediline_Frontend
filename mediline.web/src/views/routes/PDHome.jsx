                                        ...
                                        items={[
                                            <>
                                                ...
                                                <Container
                                                    ...
                                                    contentClass="pt-5 scrollable postList"
                                                    content={[
                                                        <>
                                                            <ItemGroup
                                                                customClass="gap-4"
                                                                                    ...
                                                                                    {/*
                                                                                        pastAppointments.length > 0 ? (
                                                                                            pastAppointments.map((appt) => (
                                                                                                <ItemGroup
                                                                                                    customClass="align-items-center gap-2 pr-2"
                                                                                                    fitParent={true}
                                                                                                    axis={false}
                                                                                                    stretch={true}
                                                                                                    style={{
                                                                                                    ...
                                                                                                    items={[
                                                                                                        <>
                                                                                                            <ItemGroup
                                                                                                                ...
                                                                                                                items={[
                                                                                                                    <>
                                                                                                                        ...
                                                                                                                        <p className="font-3 font-semibold text-neutral-600">{dashboardLayoutViewModel.formatBirthDate(appt.appointmentDate)}</p>
                                                                                                                    </>
                                                                                                                ]}
                                                                                                            />
                                                                                                            <ItemGroup
                                                                                                            ...
                                                                                                            <p className="font-3 font-semibold text-neutral-600">${appt.fixedFee}</p>
                                                                                                            <ItemGroup
                                                                                                                items={[
                                                                                                                    <>
                                                                                            ...
                                                                                            <Container
                                                                                                ...
                                                                                                content={[
                                                                                                    <>
                                                                                                        <p className="font-3 font-semibold text-primary-neutral-100">You have no pending invoices</p>
                                                                                                    </>
                                                                                                ]}
                                                                                            />
                                                                                        )
